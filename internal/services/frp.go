...
// GenerateClientConfig creates frpc INI config for the client
func (f *FRPService) GenerateClientConfig(subdomain string, ports []models.TunnelPort) string {
	...
	sb.WriteString("# Generated by VoidLink Tunnel Service\n\n")
	...
	// Proxy sections for each port (INI)
	for _, port := range ports {
